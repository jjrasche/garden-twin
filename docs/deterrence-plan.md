...
Counts, placement geometry, and effective radii codified in `src/core/data/pests.ts`.
...
| May 15 | Transplant marigolds (34). Direct sow: 22 nasturtium, 10 calendula, 12 alyssum |
