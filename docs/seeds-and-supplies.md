# Seed & Supply Analysis -- 2026 Season
...
| Marigold (Bonanza) | 34 | **35** | **70** | ~100 | **Soil blocks** | Covered |
...
| Calendula (Alpha) | 10 | -- | 12 | 200 | Direct sow | 17x surplus |
| Nasturtium (Trailing) | 22 | -- | 26 | 230 | Direct sow | 9x surplus |
| Sweet Alyssum | 12 | -- | 14 | 100 | Direct sow | 7x surplus |
...
- **Demand: 179 blocks. Covered with +51 spare.**

### Heat mat batching (104 blocks fit per cycle)

| Cycle | What | Blocks | When |
|-------|------|--------|------|
| 1 | Kale batch A + all tomatoes + marigold | 69 + 21 + 35 = 125 | Now (late March) |
| 2 | Kale batch B | 54 | ~Mar 28 |

Germination: 5-7 days on heat mat per cycle, then move to lights.
All 179 blocks under lights by ~Apr 5.
...
| ~May 15 | Direct sow companions at zone borders. |
